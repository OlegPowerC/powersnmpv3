...
go test -v -tags=integration -args \
    ...
    -c <COMMUNITY>
```
The **community** string must be **RW** for all integration tests to pass  

**Example:**
```bash
go test -v -tags=integration -args -h 192.168.1.252 -u SNMPv3-U -a sha -A test123 -x aes -X test321 -c private123
```
