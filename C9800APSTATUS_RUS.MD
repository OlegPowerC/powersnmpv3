...
далее запрос на получение списка точек доступа, Bulkwalk (он же getBulkRequest) и на него получен один ответ со всеми точками доступа   
